...
// INÍCIO DA ÁREA DE CONFIGURAÇÃO
    ...
    $agencia = '0058'; // 4 posições
    $conta = '27479';  // 5 posições sem dígito
    $carteira = '175'; // A sem registro é 175 para o Itaú
    $moeda = '9'; // Sempre será 9 pois deve ser em Real
    $nossonumero = '51'; // Número PEDIDO de controle do Emissor (pode usar qq número de até 8 digitos);
    $data = date('d/m/Y'); // Data de emissão do boleto
	$vencimento = date('Y/m/d')+7; // Data no formato dd/mm/yyyy
