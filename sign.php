...
<div id="wrapper">
  ...
  <div id="header" class="container">
		...
		<div id="banner">
            ...
            <div id="menuBar"> <a href="index.php">Inicio</a> | <!-- InstanceBeginEditable name="MenuBar" -->Cadastre-se <!-- InstanceEndEditable --></div>
  </div>
	<!-- end #header -->
    <div id="page">
	<div id="sidebar">
      ...
      <table width="93%" border="0" align="center">
        <tr>
          <td colspan="2" align="center"><strong>Adicionar Usu?rio</strong></td>
          </tr>
        <tr>
          <td width="26%"><strong>Nome</strong></td>
          <td width="74%"><label for="txtnome"></label>
          <input name="txtnome" type="text" id="txtnome" size="75" /></td>
        </tr>
        <tr>
          <td><strong>Login</strong></td>
          <td><input name="txtlogin" type="text" id="txtlogin" size="30" maxlength="30" /></td>
        </tr>
        <tr>
          <td><strong>Senha</strong></td>
          <td><input name="txtsenha" type="text" id="txtsenha" size="15" maxlength="15" /></td>
        </tr>
        <tr>
          <td><strong>Data Nascimento</strong></td>
          <td>Dia
            <input name="txtnascimentoDia" type="text" id="txtnascimentoDia" size="2" maxlength="2" /> 
            Mês:
            <input name="txtnascimentoMes" type="text" id="txtnascimentoMes" size="2" maxlength="2" /> 
            Ano:
            <input name="txtnascimentoAno" type="text" id="txtnascimentoAno" size="4" maxlength="4" /></td>
        </tr>
        <tr>
          <td><strong>Email</strong></td>
          <td><input name="txtemail" type="text" id="txtemail" size="50" maxlength="80" /></td>
        </tr>
        <tr>
          <td><strong>Endereço</strong></td>
          <td><label for="txtendereco"></label>
          <input name="txtendereco" type="text" id="txtendereco" size="60" /></td>
        </tr>
        <tr>
          <td><strong>Número</strong></td>
          <td><input name="txtnumero" type="text" id="txtnumero" size="15" /></td>
        </tr>
        <tr>
          <td><strong>Bairro</strong></td>
          <td><input name="txtbairro" type="text" id="txtbairro" size="30" /></td>
        </tr>
        <tr>
          <td><strong>Estado</strong></td>
          <td><input name="txtuf" type="text" id="txtuf" size="15" /></td>
        </tr>
        <tr>
          <td><strong>Cidade</strong></td>
          <td><input name="txtcidade" type="text" id="txtcidade" size="30" /></td>
        </tr>
        <tr>
          <td><strong>CEP</strong></td>
          <td><input name="txtCEP" type="text" id="txtCEP" size="11" maxlength="11" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td><input type="reset" name="button2" id="button2" value="Limpar Campos" /></td>
        </tr>
      </table>
</form>
