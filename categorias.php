...
-->
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/trator.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
<div id="wrapper">
  ...
  <div id="header" class="container">
		...
		<div id="banner">
            ...
            <div id="menuBar"> <a href="index.php">Inicio</a> | <!-- InstanceBeginEditable name="MenuBar" -->Categoria | <!-- InstanceEndEditable --></div>
  </div>
	<!-- end #header -->
    <div id="page">
	<div id="sidebar">
