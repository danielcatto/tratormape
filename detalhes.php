...
<div id="wrapper">
  ...
  <div id="header" class="container">
		...
		<div id="banner">
            ...
            <div id="menuBar"> <a href="index.php">Inicio</a> | <!-- InstanceBeginEditable name="MenuBar" -->&nbsp; produtos | detalhes <!-- InstanceEndEditable --></div>
  </div>
	<!-- end #header -->
    <div id="page">
	<div id="sidebar">
...
<?php
$id = $_GET['id'];
$query = "select p.* as produtos, c.* as categoria, f.* as fabricante from produtos p inner join fabricante f inner join categoria c on p.categoria = c.idCategoria and p.fabricante = f.idFabricante where id = '$id'";
$exec = mysql_query($query, $conexao) or die(mysql_error()); 
$total = mysql_num_rows($exec);

while($data = mysql_fetch_array($exec, MYSQL_ASSOC )) {	 
?>
<table width="800" height="31" border="0" align="left" cellpadding="0" cellspacing="0">
         <tr> 
           <th width="68%" rowspan="7" scope="col"><?php echo '<a rel="lightbox" title="'.$data['nome'].'" href="produtos/'.$data['imagem1'].'">';?><img src='produtos/<?php echo $data["imagem1"]; ?>' alt='Foto Produtos' width='531' height='281' /></a>
           
           <td width="32%" align="left" scope="col">
            </td>
           </tr>
         <tr>
         ...
         <tr>
           <td align="left" scope="col"><?php echo $data["nomeFabricante"];	?></td>
         </tr>
         <tr>
           <td align="left" scope="col"><?php echo $data["nome"];	?></td>
         </tr>
         <tr>
           <td align="left" scope="col">&nbsp;</td>
         </tr>
         ...
         <tr>
		   ...
		   $qtd = $data["qtd"];
		   if ($qtd <= 0){echo '<h3>Produto Esgotado</h3>';}else{
		   
		    echo'<a href="carrinho.php?acao=add&id='.$data['id'].'"><img src="icones/add.gif" alt="" width="150" height="30" /></a>';}?></td>
         </tr>

	        <tr>
						      <td colspan="2"> <?php echo '<a rel="lightbox" title="'.$data['nome'].'" href="produtos/'.$data['imagem2'].'">';?><img src='produtos/<?php echo $data["imagem2"]; ?>' alt='Foto Produtos' width='272' height='200' /></a><?php echo '<a rel="lightbox" title="'.$data['nome'].'" href="produtos/'.$data['imagem3'].'">';?><img src='produtos/<?php echo $data["imagem3"]; ?>' alt='Foto Produtos' width='270' height='200' /></a></td>
	        </tr>
						    <tr>
						      <td colspan="2"><?php echo $data["descricao"]; ?>'</td>
					        </tr>
					    </table><?php }  ?>
