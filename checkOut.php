...
$_SESSION['urlCarrinho'] = $UrlAtual;


if (count($_SESSION['carrinho']) == 0){

	echo 'o carrinho está vazio <br> <a href="index.php">continuar comprando</a>';	
		
}
else if (($_SESSION['nivelUsuario'] == "") or ($_SESSION['validacodigo'] ==  "") or ($_SESSION['validalogin'] == "") )  {
?>	
...
echo 'Bem vindo '.$_SESSION['validanome'].'<br> Se você não é esta pessoa <a href="../log_out.php">Clique aqui</a><br><br>';
	
			
echo '<a href="formaPag.php"><img src="icones/continuar.gif" alt="" width="150" height="30" /></a>';
		//echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=/produtos/checkOut.php'>";
}?>
