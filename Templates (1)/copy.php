...
<body>
 <div id="menuTopo">
	<!--  foto usuario e saudação -->&nbsp; <a href="../login.php">Entrar com sua conta</a> / <a href="file:///C|/wamp/carrinho.php">Carrinho</a> / Pedidos
	<!-- fim -->
	</div>
...
<div id="wrapper">
  ...
  <div id="header" class="container">
		...
		<div id="banner">
			<div class="content"><img src="../images/img02.jpg" width="1000" height="200" alt="" /></div>
		</div>
	</div>
	<!-- end #header -->
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Bem vindos</a></h2>
				<p class="meta"><span class="date">September 12, 2012</span><span class="posted"><a href="#">e</a></span></p>
...
<div id="footer">
	<p>Copyright (c) 2012 Trator Mape. All rights reserved. Design by <a href="http://ipiso.no-ip.info">SUBA Aplicativos Web</a></p>
</div>
<!-- end #footer -->
</body>
</html>
