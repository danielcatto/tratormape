...
<div id="wrapper">
  ...
  <div id="header" class="container">
		...
		<div id="banner">
            ...
            <div id="menuBar"> <a href="index.php">Inicio</a> | <!-- InstanceBeginEditable name="MenuBar" -->&nbsp;Meus Pedidos<!-- InstanceEndEditable --></div>
  </div>
	<!-- end #header -->
    <div id="page">
	<div id="sidebar">
		...
		<div id="content">
			...
			<div class="post">
				...
				<div style="clear: both;">&nbsp;<!-- InstanceBeginEditable name="conteúdo" -->
				  <p>
<?php echo 'idUser'. $idUser = $_SESSION['validacodigo'];
$query = "SELECT * FROM pedido WHERE idUsPedido = '$idUser'";
$resultado = mysql_query($query,$conexao);
...
if ($num > 0){
	while ($linha = mysql_fetch_array($resultado)){
 	echo  "<strong>Pedido </strong>". '<a href="detalhePedido.php?numpedido='.$linha['numPedido'].'">'.$linha['numPedido']."</a><br>"; 
	echo  "Valor Total R$: ".$linha['totalpedido']."<br>";
	echo "Data do Pedido: " . $linha['datapedido']; 
	echo '<hr color="#666666">';
	}
                  
}else {echo '<h3>Nenhum pedido encontrado</h3>';}
?>            
