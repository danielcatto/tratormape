...
// Corpo da Mensagem
   $mensagem = '<html>
        ...
        <b>Muitas Felicidades, é o que deseja toda a equipe da (sua empresa)!!!</b><br><br>                              
           <img src=http://www.suaempresa.com/imagens/imagem.jpg><br>
                                </font>
                                </body>
                                </html>';
...
// Headers
   ...
   $headers .= "From: Sua empresa <email@provedor.com.br>\n";

 $query = "SELECT * FROM usuarios where idade = '1980-09-24'";
						$resultado = mysql_query($query,$conexao);
		
						while ($idade = mysql_fetch_array($resultado)) 
						{
							echo '<li> <a href="categorias.php?categoria='.$idade['idCategoria'].'">'.$idade['categoria']. "</a></li>";
						}// fim montar menu
						
						
						
$aniversario = mysql_query("SELECT * FROM usuarios WHERE idade > $date");
