...
-- Dumping data for table banco.dialogin: ~38 rows (approximately)
...
REPLACE INTO `dialogin` (`codigo`, `nivelUsuario`, `data`, `hora`, `dataOut`, `horaOut`) VALUES
	...
	(79, 'onUser', '13/07/2013', '11:48:06', '2013/07/13', '14:21:49'),
	(79, 'onUser', '13/07/2013', '20:20:51', '2013/07/13', '20:32:26'),
	(79, 'onUser', '13/07/2013', '20:32:36', '2013/07/13', '20:32:58'),
	(79, 'onUser', '13/07/2013', '20:33:22', '', '');
...
-- Dumping data for table banco.formapagamentos: ~5 rows (approximately)
/*!40000 ALTER TABLE `formapagamentos` DISABLE KEYS */;
REPLACE INTO `formapagamentos` (`idpf`, `formaPagamento`) VALUES
	(2, 'Boleto Bancário'),
	(3, 'Visa  Credito'),
	(4, 'MastarCard Credito'),
	(5, 'Visa Eletron Debito'),
	(6, 'Master Card Maestro Debito');
...
-- Dumping data for table banco.itens_pedido: ~15 rows (approximately)
/*!40000 ALTER TABLE `itens_pedido` DISABLE KEYS */;
REPLACE INTO `itens_pedido` (`pedidoItens`, `idproduto`, `qtdItens`, `valor`) VALUES
	(1, 1, 2, 250125.75),
	(1, 2, 1, 15359.45),
	(25, 1, 1, 250125.75),
	(26, 1, 1, 250125.75),
...
REPLACE INTO `juros` (`juros`, `desconto`) VALUES
	(0.99, 5.00);
...
-- Dumping data for table banco.parcelamento: ~15 rows (approximately)
...
REPLACE INTO `parcelamento` (`idPar`, `numpar`, `parcelamento`, `juros`) VALUES
	...
	(5, '1', 'Visa Eletron Debito - 1 parcela', ''),
	(6, '1', 'Master Card Maestro - 1 parcela', '');
...
CREATE TABLE IF NOT EXISTS `pedido` (
  ...
  `titularCartao` varchar(30) default NULL,
  `numeroCartao` varchar(12) default NULL,
  `codigoCartao` varchar(4) default NULL,
  `validadeCartao` varchar(5) default NULL,
  `numeroBoleto` varchar(70) default NULL,
  KEY `numPedido` (`numPedido`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8;

-- Dumping data for table banco.pedido: ~13 rows (approximately)
/*!40000 ALTER TABLE `pedido` DISABLE KEYS */;
REPLACE INTO `pedido` (`numPedido`, `idUsPedido`, `formaPagamento`, `parcelamento`, `valorparcela`, `desconto`, `totalpedido`, `totalReceber`, `datapedido`, `horapedido`, `jurototal`, `titularCartao`, `numeroCartao`, `codigoCartao`, `validadeCartao`, `numeroBoleto`) VALUES
	(1, 79, 4, 1, 520715.50, 0.00, 515610.95, 0.00, '2013-07-13', '12:33:11', '0.99', 'danilo donizete catto', '121212121212', '656', '12/15', ''),
	(25, 79, 3, 3, 85851.49, 0.00, 500251.50, 0.00, '2013-07-16', '23:34:36', '2.97', 'danilo donizete catto', '121212121212', '656', '12/15', 'null'),
	(26, 79, 3, 3, 85851.49, 0.00, 250125.75, 257554.48, '2013-07-16', '23:40:27', '2.97', 'asdf', '121212121212', '656', '12/15', 'null'),
	(27, 79, 3, 3, 91123.37, 0.00, 265485.20, 273370.11, '2013-07-16', '23:43:32', '2.97', 'danilo donizete catto', '121212121212', '656', '12/15', 'null'),
	(28, 79, 3, 3, 5119.82, 0.00, 15359.45, 15359.45, '2013-07-17', '00:03:21', '0', 'asdf', '121212121212', '656', '12/15', 'null'),
	(29, 79, 3, 3, 5119.82, 0.00, 15359.45, 15359.45, '2013-07-17', '00:09:49', '0', 'asdf', '121212121212', '656', '12/15', 'null'),
	(30, 79, 3, 3, 85851.49, 0.00, 250125.75, 257554.48, '2013-07-17', '00:41:36', '2.97', 'danilo donizete catto', '121212121212', '656', '12/15', 'null'),
	(31, 79, 2, 1, 0.00, 0.00, 250125.75, 250120.75, '2013-07-17', '00:43:35', '0', '', '', '', '', 'null'),
	(32, 79, 2, 1, 0.00, 0.00, 250125.75, 250120.75, '2013-07-17', '00:46:23', '0', '', '', '', '', 'null'),
	(33, 79, 2, 1, 0.00, 12506.29, 250125.75, 237619.46, '2013-07-17', '20:23:35', '0', '', '', '', '', 'null'),
	(34, 79, 3, 3, 85851.49, 0.00, 250125.75, 257554.48, '2013-07-17', '20:27:03', '2.97', 'asdf', '121212121212', '656', '12/16', 'null'),
	(35, 79, 2, 1, 0.00, 12506.29, 250125.75, 237619.46, '2013-07-17', '20:30:58', '0', '', '', '', '', 'null'),
	(36, 79, 2, 1, 0.00, 12506.29, 250125.75, 237619.46, '2013-07-17', '20:32:01', '0', '', '', '', '', 'null'),
	(37, 79, 2, 1, 0.00, 12506.29, 250125.75, 237619.46, '2013-07-17', '20:33:07', '0', '', '', '', '', 'null'),
	(38, 79, 3, 3, 85851.49, 0.00, 250125.75, 257554.48, '2013-07-17', '21:36:55', '2.97', 'danilo donizete catto', '121212121212', '656', '12/15', 'null');
...
REPLACE INTO `produtos` (`id`, `idfabri`, `nome`, `descricao`, `categoria`, `fabricante`, `qtd`, `valor`, `destaque`, `lancamento`, `caminho`, `imagem1`, `imagem2`, `imagem3`, `dataUpdate`) VALUES
	(1, '2010G1265015', 'Trator Massey Ferguson 290 4x2 ano 84 ', 'muito bom sô', 2, 1, 73, 250125.75, 'sim', 'nao', 'produtos', 'trator.jpg', '', '', '2012-10-01'),
	(2, '201086686011', 'TRATOR PA CARREGADEIRA', 'MUITO BOA MESMO', 3, 1, 96, 15359.45, 'SIM', 'SIM', '../produtos/', 'af30ebeeaaad3b39c85bfdb4ca9ddcee.jpg', '6496600529468188ff9936813d312ce9.jpg', 'da31fcf4c6e6cb491719b0e372ccf55e.jpg', '2012-10-20');
...
REPLACE INTO `usuarios` (`idUs`, `nomeUs`, `login`, `senha`, `cpf`, `email`, `endereco`, `numero`, `bairro`, `uf`, `cidade`, `CEP`, `caminhoUs`, `fotoUs`, `nivelUsuario`) VALUES
