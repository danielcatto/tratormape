		...
		<div id="content">
			...
			<div class="post">
				...
				<div style="clear: both;">&nbsp;<!-- InstanceBeginEditable name="conteúdo" -->
				 <?php
$id =  $_SESSION['validacodigo'];
$query = "SELECT * FROM usuarios where idUs = '$id' order by idUs desc" ;
$resultado = mysql_query($query,$conexao);
?>
<form id="form1" name="form1" method="post" action="userChange.php">
<?php   
	while ($linha = mysql_fetch_array($resultado)) {

$_SESSION['senhaatual'] = $linha['senha'];?>

      <table width="99%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          <th colspan="2" align="center" bgcolor="#E1E1E1" scope="col">Editar Cadastro</th>
          </tr>
        <tr>
          <th width="35%" align="left" scope="col">Confirme sua senha</th>
          <th width="65%" align="left" scope="col"><input type="password" name="senhaatual" id="senhaatual" /></th>
        </tr>
        <tr>
          <th width="35%" align="left" scope="col">ID Codigo</th>
          <th width="65%" align="left" scope="col"><?php echo $linha['idUs'];?></th>
        </tr>
        <tr>
          <td align="left">Nome Usuário</td>
          <td align="left"><input name="nome" type="text" id="nome"  value="<?php echo $linha["nomeUs"]; ?>" size="70" /></td>
        </tr>
        <tr>
          <td align="left">Login</td>
          <td align="left"><input name="login" type="text" id="login2" value="<?php echo $linha["login"];?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="left"><label for="rnovaSenha">Repita nova senha</label></td>
          <td align="left"><input type="password" name="rnovaSenha" id="rnovaSenha" /></td>
        </tr>
        <tr>
          <td align="left">Email.</td>
          <td align="left"><input name="email" type="text" id="login" value="<?php echo $linha['email'] ;?>" size="62" maxlength="50" /></td>
        </tr>
        <tr>
          <td colspan="2" align="left"><?php echo '<a href="alterarfoto.php">Alterar Foto</a>'; ?></td>
          </tr>
      </table>
      <p>
        <?php $_SESSION['senhaatual'] = $linha['senha'];?>
        <br />
