		...
		<div id="content">
			...
			<div class="post">
				...
				<div style="clear: both;">&nbsp;<!-- InstanceBeginEditable name="conteúdo" -->
                  ...
                  <div class="entry">
						  <p>Boleto Banário<br />
                          <a href="confirm.php?FPagamento=2"><img src="icones/2.jpg" alt="" width="131" height="68" /></a> </p>
                          <hr />
						  <p>Cartão de Crédito</p>
						  <table width="611" border="0">
						    <tr>
						      <td width="135"><a href="confirm.php?FPagamento=3"><img src="icones/3.jpg" alt="" width="131" height="68" /></a></td>
						      <td width="460">&nbsp;</td>
					        </tr>
						    <tr>
						      <td><a href="confirm.php?FPagamento=4"><img src="icones/4.jpg" alt="" width="131" height="68" /></a></td>
						      <td>&nbsp;</td>
					        </tr>
					      </table>
						  <p><br />
						  ...
						  <p>&nbsp;</p>
						  <hr />
						  <p>Catão de Débito<br />
                          <a href="confirm.php?FPagamento=6"><img src="icones/5.jpg" alt="" width="130" height="68" /></a>						  <a href="confirm.php?FPagamento=5"><img src="icones/6.jpg" alt="" width="131" height="68" /></a></p>
						  <hr />
						  <p>&nbsp;</p>
						  <p>&nbsp;</p>
                          </div>
