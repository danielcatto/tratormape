...
<div id="wrapper">
  ...
  <div id="header" class="container">
		...
		<div id="banner">
            ...
            <div id="menuBar"> <a href="index.php">Inicio</a> | <!-- InstanceBeginEditable name="MenuBar" -->&nbsp; cadastro | carregar foto<!-- InstanceEndEditable --></div>
  </div>
	<!-- end #header -->
    <div id="page">
	<div id="sidebar">
...
$caminho = $_SESSION['cadastroCaminho'];
$_UP['pasta'] = 'fotos/'.$caminho.'/';
...
// grava no banco cadastro e nome da foto 
$atualiza = "UPDATE usuarios  SET  fotoUs = '$nome_final' where nomeUs = '$nomeid'";
