...
include ('../load.php');
$idfabricante = $_SESSION['idfabricante'];
$nomeprod = $_SESSION['nomeprod'];
$descricaoprod = $_SESSION['descricaoprod'];
$fabricanteprod = $_SESSION['fabricanteprod'];
$categoriaprod = $_SESSION['categoriaprod'];
$destaqueprod = $_SESSION['destaqueprod'];
$lancamentoprod = $_SESSION['lancamentoprod'];
$qtdprod = $_SESSION['qtdprod'];
$valorprod = $_SESSION['valorprod'];

if (($nomeprod == "") and ($descricaoprod == "") and ($fabricanteprod == "") and ($categoriaprod == "") and ($destaqueprod == "")){
echo "Insera os dados completos";
echo "<meta HTTP-EQUIV='Refresh' CONTENT='3;URL=addprodutos.php'>";
}else{
$query = "SELECT * FROM produtos WHERE nome = '$nomeprod'";
$resultado = mysql_query($query,$conexao);
...
echo "Dados duplicados... Favor verificar !!!";}
...
$campos = 3 ; 
   ...
   if ( ($name!="") and (is_file($f_tmp[$i])) and (in_array(substr($name, -3),$ext)) ) { 
     ...
     if ($cont==0) { 
       ...
       echo "<br />"; 
			...
			$sql = mysql_query("INSERT INTO produtos VALUES ('','".$idfabricante."' , '".$nomeprod."', '".$descricaoprod."', '".$categoriaprod."', '".$fabricanteprod."', '".$qtdprod."', '".$valorprod."', '".$destaqueprod."', '".$lancamentoprod."', '".$dir."', '".$imagem['0']."', '".$imagem['1']."',  '".$imagem['2']."', '".$date['Y-m-d']."' )");
			
			$_SESSION['nomeprod'] = "";
			$_SESSION['descricaoprod'] = "";
			$_SESSION['fabricanteprod'] = "";
			$_SESSION['categoriaprod'] = "";
			$_SESSION['destaqueprod'] = "";
 ...
 echo '<a href="addProdutos.php">Cadastrar outro</a>';
 } 
}
}
