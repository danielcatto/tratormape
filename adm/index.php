		...
		<div id="content">
			...
			<div class="post">
				...
				<div style="clear: both;">&nbsp;<!-- InstanceBeginEditable name="conteúdo" -->
				  <p>
						  <p><a href="addProdutos.php">Add produtos</a></p>
                          <p><a href="ver_produtos.php">Ver todos os produtos</a></p>
                          <p><a href="up_produto.php">atualizar produto</a></p>
                          <p><a href="ver_usuarios.php">ver todos os usu?rios&nbsp;</p>
                  <div class="entry">
