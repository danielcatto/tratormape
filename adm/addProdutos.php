...
<div id="wrapper">
  ...
  <div id="header" class="container">
		...
		<div id="banner">
            ...
            <div id="menuBar"> <a href="../index.php">Inicio</a> | <!-- InstanceBeginEditable name="MenuBar" -->&nbsp; heme<!-- InstanceEndEditable --></div>
  </div>
	<!-- end #header -->
    <div id="page">
	<div id="sidebar">
		...
		<div id="content">
			...
			<div class="post">
				...
				<div style="clear: both;">&nbsp;<!-- InstanceBeginEditable name="conteúdo" -->
				  <p> <form action="addprodutos_p2.php" method="post" enctype="multipart/form-data" name="cadastro" >
  <p>Codigo Fabricante:<br />
    <label for="txtidfabricante"></label>
    <input name="txtidfabricante" type="text" id="txtidfabricante" value="" size="15" />
  </p>
  <p>Nome:<br />
    <input name="txtnome" type="text" id="txtnome" size="90" maxlength="50" />
  </p>
  <p>descricao<br />
    <label for="txtdescricao"></label>
    <textarea name="txtdescricao" cols="60" rows="10" id="txtdescricao"></textarea>
    <br />
    <label for="txtimagem"></label>
    </p>
  <p>Quatidade<br />
    <label for="txtqtd"></label>
    <input type="text" name="txtqtd" id="txtqtd" />
  </p>
  <p>Valor<br />
    <label for="txtvalor"></label>
    <input type="text" name="txtvalor" id="txtvalor" />
    <br />
  </p>
  <p>Fabricante
    <label for="txtfabricante"></label>
    <br />
     <?php  include ('../load.php');
		$queryfab = "SELECT * FROM fabricante ORDER BY nomefabricante" ; 
						$resultado = mysql_query($queryfab,$conexao);?>
            
            <select name="bxfabricante" id="bxfabricante">
              <option value="dd">Escolha a Op??o	</option>
              
              <?php while ($fabricante = mysql_fetch_array($resultado)) 
			{ ?>
  ...
  <p><br />
   ...
   <?php 
		$querycat = "SELECT * FROM categoria ORDER BY categoria" ; 
						$resultado = mysql_query($querycat,$conexao);?>
        	
          <select name="bxcategoria" id="bxcategoria">
          <option value="dd">Escolha a Op??o	</option>
         
    <?php while ($categoria = mysql_fetch_array($resultado)) 
			{ ?>
  ...
  <p>Destaque<br />
    <label for="txtdestaque"></label>
    <label for="bxdestaque"></label>
    <select name="bxdestaque" id="bxdestaque">
      <option value="SIM">SIM</option>
      <option value="NAO">N?O</option>
    </select>
    <br />
    </p>
  <p>Vai estar em Lan?amento de produtos<br />
    <label for="txtdestaque2"></label>
    <label for="bxlancamento"></label>
    <select name="bxlancamento" id="bxlancamento">
      <option value="SIM">SIM</option>
      <option value="NAO">N?O</option>
    </select>
  <br /><br />
...
<?php echo "nome Produto: ".$_SESSION['nomeprod']. "<BR>";
echo "Descri??o: ".$_SESSION['descricaoprod']. "<BR>";
	echo "Categoria: ".$_SESSION['categoriaprod']. "<BR>";
	echo "Fabricante: ".$_SESSION['fabricanteprod']. "<BR>";
	echo "destaque: ".$_SESSION['destaqueprod']. "<BR>";?>
