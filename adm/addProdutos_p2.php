		...
		<div id="content">
			...
			<div class="post">
				...
				<div style="clear: both;">&nbsp;<!-- InstanceBeginEditable name="conteúdo" -->
				  <?php
$_SESSION['idfabricante'] = strtoupper($_POST['txtidfabricante']);
$_SESSION['nomeprod'] = strtoupper($_POST['txtnome']);
$_SESSION['descricaoprod'] = strtoupper($_POST['txtdescricao']);
$_SESSION['fabricanteprod'] = strtoupper($_POST['bxfabricante']);
$_SESSION['qtdprod'] = strtoupper($_POST['txtqtd']);
$_SESSION['valorprod'] = strtoupper($_POST['txtvalor']);
$_SESSION['categoriaprod'] = strtoupper($_POST['bxcategoria']);
$_SESSION['destaqueprod'] = strtoupper($_POST['bxdestaque']);
$_SESSION['lancamentoprod'] = $_POST['bxlancamento'];
		
echo 'codigo fabricante: '.$_SESSION['idfabricante'];
echo "<br>nome: ".$_SESSION['nomeprod']. "<BR>";
...
echo "Lam?amento: ".$_SESSION['lancamentoprod']. "<BR>";
echo 'qtd '.$_SESSION['qtdprod'];
echo 'valor '.$_SESSION['valorprod']; 
echo '<form method="post" action="addprodutos_p3.php"
