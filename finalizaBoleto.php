...
foreach($_SESSION['carrinho'] as $id => $qtd){
	...
	$resultado = mysql_query($verificaProduto,$conexao);
		...
		if ($qtd > $realQtd){echo '<br> <strong >produto esgotado</strong>';}
			...
			if (!empty($user)){
		//grava pedido
			$inserir = "INSERT INTO pedido VALUES ('', '$user', '$formapagamento', '1', '0', '0', '$total', '$datapedido', '$horapedido', '$totaljuros', '$titularCartao' ,'$numeroCartao' , '$codigoSegurancaCartao' , '$dataValidadeCartao')";
			...
			foreach($_SESSION['carrinho'] as $id => $qtd){
				...
				echo 'Parabéns seu pedido foi realizada com sucesso, aguarde a confirmação do pagamento!<br><a href="meusPedidos.php"> Ver Pedido</a>';
